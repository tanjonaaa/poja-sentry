...
import com.poja.sentry.endpoint.event.EventConsumer;
import com.poja.sentry.endpoint.event.gen.UuidCreated;
...
public class SqsMessageAckTyperTest extends FacadeIT {
  ...
  void to_acknowledgeable_typed_event_ok() throws JsonProcessingException {
    ...
    var typedEvent =
        new EventConsumer.TypedEvent("com.poja.sentry.endpoint.event.gen.UuidCreated", payload);
